...
5. Create secrets.json file and add the key discordToken with your token as the value
6. Run stockBot.py
7. (Additional) [Invite bot to your server](https://github.com/jagrosh/MusicBot/wiki/Adding-Your-Bot-To-Your-Server)
